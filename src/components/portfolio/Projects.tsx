            ...
            <div className="lg:col-span-7 relative group z-10">
              <div className="rounded-xl overflow-hidden border border-slate-700 bg-dev-surface shadow-2xl glow-card">
                <div className="bg-[#161f33] px-4 py-2 border-b border-slate-700 flex items-center gap-2">
                  ...
                  <div className="mx-auto text-[10px] text-slate-500 font-mono bg-slate-800/50 px-4 py-1 rounded-md">models/cnn_classifier.py</div>
                </div>
                <div className="relative">
                  <div className="bg-[#0d1117] p-6 h-[320px] overflow-hidden text-left">
                    <div className="font-mono text-[13px] text-slate-300 leading-relaxed">
                      <span className="text-pink-400">import</span> torch<br/>
                      <span className="text-pink-400">import</span> torch.nn <span className="text-pink-400">as</span> nn<br/>
                      <br/>
                      <span className="text-pink-400">class</span> <span className="text-green-400">BrainTumorClassifier</span>(nn.Module):<br/>
                      &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-pink-400">def</span> <span className="text-blue-400">__init__</span>(self):<br/>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-blue-400">super</span>().__init__()<br/>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-slate-500"># CNN architecture for MRI scans</span><br/>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self.conv1 = nn.Conv2d(<span className="text-orange-400">1</span>, <span className="text-orange-400">32</span>, kernel_size=<span className="text-orange-400">3</span>)<br/>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self.pool = nn.MaxPool2d(<span className="text-orange-400">2</span>, <span className="text-orange-400">2</span>)<br/>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;self.fc1 = nn.Linear(<span className="text-orange-400">32</span> * <span className="text-orange-400">126</span> * <span className="text-orange-400">126</span>, <span className="text-orange-400">2</span>)<br/>
                      <br/>
                      &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-pink-400">def</span> <span className="text-blue-400">forward</span>(self, x):<br/>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;x = self.pool(torch.relu(self.conv1(x)))<br/>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;x = x.view(x.size(<span className="text-orange-400">0</span>), -<span className="text-orange-400">1</span>)<br/>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-pink-400">return</span> self.fc1(x)<br/>
                    </div>
                  </div>
                  <div className="absolute inset-0 bg-dev-primary/10 mix-blend-multiply group-hover:bg-transparent transition-all duration-500"></div>
                </div>
              </div>
            </div>
            
            <div className="lg:col-span-5 lg:text-right relative z-20">
              <div className="inline-flex items-center gap-2 px-2 py-1 rounded border border-purple-500/20 bg-purple-500/10 text-purple-400 text-[10px] font-mono mb-4">
                <span className="w-1.5 h-1.5 rounded-full bg-purple-500 animate-pulse"></span> Deep Learning
              </div>
              <h3 className="text-2xl font-bold text-white mb-6 hover:text-dev-primary transition-colors cursor-pointer">MRI Brain Tumor Prediction</h3>
              <div className="glass-panel p-6 rounded-xl shadow-xl text-slate-300 text-sm leading-relaxed mb-6 lg:-ml-12 border border-slate-700/50 backdrop-blur-xl relative">
                Developed a Convolutional Neural Network (CNN) to predict and classify brain tumors from MRI medical scans. Achieved high accuracy in automating medical image diagnostics.
              </div>
              <ul className="flex flex-wrap lg:justify-end gap-3 font-mono text-xs text-slate-400 mb-6">
                ...
                <li className="text-dev-primary">PyTorch</li>
                <li className="text-dev-primary">Computer Vision</li>
                <li className="text-dev-primary">NumPy</li>
              </ul>
